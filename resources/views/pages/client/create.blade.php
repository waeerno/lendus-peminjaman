    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="live-preview">
                <form action="{{ route('pengguna.client.store') }}" method="POST" class="row g-3">
                    @csrf

                    <div class="col-md-6">
                        <label for="fullnameInput" class="form-label">Nomor Induk</label>
                        <input type="number" name="no_induk" id="no_induk" class="form-control @error('no_induk') is-invalid @enderror" value="{{ old('no_induk') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="no_wa" id="no_wa" class="form-control @error('no_wa') is-invalid @enderror" value="{{ old('no_wa') }}">
                        @error('no_wa')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
