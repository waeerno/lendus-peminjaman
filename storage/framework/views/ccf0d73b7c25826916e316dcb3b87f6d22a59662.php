    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="live-preview">
                <form action="<?php echo e(route('pengguna.client.update',$data->id)); ?>" method="post" class="row g-3">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('no_induk') ?? $data->no_induk); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('no_wa') ?? $data->no_wa); ?>">
...
unset($__errorArgs, $__bag); ?>" id="unit_id" name="unit_id" required>
                            ...
                            <option value="<?php echo e($item->id); ?>" <?php if(old('unit_id')==$item->id || $item->id == $data->unit_id): echo 'selected'; endif; ?>><?php echo e($item->nama); ?>
...
unset($__errorArgs, $__bag); ?>" id="jenis" name="jenis" required>
                            ...
                            <option value="Mahasiswa" <?php if(old('jenis')==$data->jenis || $data->jenis == 'Mahasiswa'): echo 'selected'; endif; ?>>Mahasiswa</option>
                            <option value="Pegawai" <?php if(old('jenis')==$data->jenis || $data->jenis == 'Pegawai'): echo 'selected'; endif; ?>>Pegawai</option>
                            <option value="Dosen" <?php if(old('jenis')==$data->jenis || $data->jenis == 'Dosen'): echo 'selected'; endif; ?>>Dosen</option>
                        </select>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\lendus-velzon\resources\views/pages/client/edit.blade.php ENDPATH**/ ?>