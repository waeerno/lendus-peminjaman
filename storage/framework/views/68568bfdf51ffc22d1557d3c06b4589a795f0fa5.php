        ...
        <nav class="navbar navbar-expand-lg navbar-landing navbar-light fixed-top" id="navbar">
            <div class="container">
                <a class="navbar-brand" href="index">
                    <img src="<?php echo e(URL::asset('assets/images/logo-dark.png')); ?>" class="card-logo card-logo-dark" alt="logo dark" height="27">
                    <img src="<?php echo e(URL::asset('assets/images/logo-light.png')); ?>" class="card-logo card-logo-light" alt="logo light" height="27">
                </a>
                    ...
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center">
                            ...
                            <div class="hstack gap-2 justify-content-center">
                                <a href="<?php echo e(route('peminjaman-client.index')); ?>" class="btn btn-primary">Lakukan Peminjaman Sekarang <i class="ri-arrow-right-line align-middle ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--end col-->
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="card text-center border shadow-none">
                            <div class="card-body py-5 px-4">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/polis.svg')); ?>" alt="" height="55" class="mb-3 pb-2">
                    ...
                    <div class="col-lg-4">
                        <div class="card text-center border shadow-none">
                            <div class="card-body py-5 px-4">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/lun.svg')); ?>" alt="" height="55" class="mb-3 pb-2">
                                <h5>Barang</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="card text-center border shadow-none">
                            <div class="card-body py-5 px-4">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/husd.svg')); ?>" alt="" height="55" class="mb-3 pb-2">
        ...
        <section class="section bg-light" id="asset">
            <div class="container">
                    ...
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            ...
                            <ul class="nav nav-pills filter-btns justify-content-center" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link fw-medium" type="button" data-filter="<?php echo e($item->nama); ?>"><?php echo e($item->nama); ?></button>
                                </li>
                ...
                <div class="row">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $asset; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-lg-4 product-item artwork crypto-card <?php echo e($item->kategori->nama); ?>">
                ...
                <div class="row">
                        ...
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/img-05.jpg')); ?>" alt="" class="avatar-xs rounded-circle">
                    ...
                    <div class="col-lg-4">
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-1.gif')); ?>" alt="" class="avatar-xs rounded-circle">
                                    <div class="ms-2 flex-grow-1">
                                        <a href="#!">
                                            <h6 class="mb-0 fs-15">Nama Barang</h6>
                                        </a>
                                ...
                                <div class="explore-place-bid-img overflow-hidden rounded">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-1.gif')); ?>" alt="" class="explore-img w-100">
                                    <div class="bg-overlay"></div>
                                </div>
                                <div class="mt-3">
                                    <p class="fw-medium mb-0 float-end">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 mt-4">
                        <div>
                            <div>
                                <img src="<?php echo e(URL::asset('assets/images/logo-light.png')); ?>" alt="logo light" height="47">
                            </div>
                            <div class="mt-4">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\lendus-velzon\resources\views/pages/landing/index.blade.php ENDPATH**/ ?>