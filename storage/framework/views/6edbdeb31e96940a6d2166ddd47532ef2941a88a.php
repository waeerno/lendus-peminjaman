    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="live-preview">
                <form action="<?php echo e(route('peminjaman.store')); ?>" method="POST" class="row g-3" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="pengguna" name="pengguna" required>
                            ...
                            <option value="<?php echo e($item->id); ?>" <?php if(old('pengguna')==$item->id): echo 'selected'; endif; ?>><?php echo e($item->nama); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-2">
                        <label for="fullnameInput" class="form-label"><?php echo e(__('jumlah')); ?></label>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('jumlah')); ?>" min="1">
...
unset($__errorArgs, $__bag); ?>" name="surat" value="<?php echo e(old('surat')); ?>">
