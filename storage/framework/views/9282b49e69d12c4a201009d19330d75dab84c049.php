        ...
        <tr>
            ...
            <td class="text-end">
                <button type="button" class="btn btn-sm btn-info " data-bs-toggle="modal"
                    data-bs-target="#detail-<?php echo e($item->id); ?>">Detail</button>

                <a href="<?php echo e(route('peminjaman.edit', $item->id)); ?>" class="btn btn-sm btn-info" data-bs-toggle="tooltip"
                ...
                <a href="#" class="btn btn-sm btn-danger" onclick="confirmDelete(<?php echo e($item->id); ?>)"
                    ...
                    <form action="<?php echo e(route('peminjaman.destroy', $item->id)); ?>" method="POST"
